...
from training.tf_v1_qat.examples.mobilenet import mobilenet as lib
from training.tf_v1_qat.examples.mobilenet import mobilenet_conv_blocks as ops
...
def learning_rate_with_decay_mobilenet(
  ...
  if flags.FLAGS.enable_lars:
    raise NotImplementedError("enable_lars not implemeted!")
