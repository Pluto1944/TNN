...
def process_checkpoint(input_ckpt, output_ckpt_path, dense_layer):
    ...
    MatMul is followed by a QDQ node in quantize. TensorRT doesn't support MatMul in INT8 now.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dense_layer', type=str, default='resnet_model/dense/kernel')
    args = parser.parse_args()

    input_ckpt = args.input

    new_ckpt = 'new.ckpt'
    new_ckpt_path = os.path.join(args.input, new_ckpt)
